...
class StravaController extends Controller
{
    public function index(Request $request)
    {
        ...
        $return = [
            'data_referencia'       => $fim->format('Y-m-d'),
            'data_inicio_semana'    => $dataInicioSemana->format('Y-m-d'),
            'data_termino_semana'   => $dataTerminoSemana->format('Y-m-d'),
            'semanas_restantes_ano' => $semanas,
            'qtde_corridas'         => count($corridas),
            'qtde_pedaladas'        => count($pedaladas),
            'digitos'               => $digitos,
            'corrida'               => $corrida,
            'pedal'                 => $pedal,
            'url'                   => $url,
